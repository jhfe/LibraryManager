...
<head>
    <meta charset="UTF-8">
    <title>Manager-Biblioteca</title>
...
<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{!! asset('images/logo_min.png') !!}" width="80" height="40"
             alt="SS-BJ-logo">
        <img class="navbar-brand-minimized" src="{!! asset('images/logo_min.png') !!}" width="30"
             height="30" alt="SS-BJ-logo">
    </a>
